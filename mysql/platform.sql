...
CREATE TABLE `column` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='系统栏目';
...
INSERT INTO `people` VALUES (6, NULL, '123456', '小吴', NULL, '954663633@qq.com', '8975-3207-8409-8455', 'B834D761-7BFB-A5F5-33F6-9C90EC3FC2D6', '127.0.0.1', 1540451311, 0);
...
CREATE TABLE `people_ext` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='人员扩展表';
...
INSERT INTO `role` VALUES (10, 'role', 'AADA4670-E3B2-A08C-D287-0DD4EA48A05D', 'table||&&||classid||&&||field||&&||roleid||&&||control', 'B834D761-7BFB-A5F5-33F6-9C90EC3FC2D6', '3');
