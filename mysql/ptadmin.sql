...
CREATE TABLE `Column` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=62 DEFAULT CHARSET=utf8 COMMENT='系统栏目';
...
CREATE TABLE `e_mail` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='邮箱表';
...
CREATE TABLE `program` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=64 DEFAULT CHARSET=utf8 COMMENT='表管理';
...
INSERT INTO `program` VALUES (57, '报错表', 'zmyq_error', 'appTitle', 'varchar', '1000', 'app名字', '0');
INSERT INTO `program` VALUES (58, '报错表', 'zmyq_error', 'error', 'varchar', '255', '错误信息', '0');
...
CREATE TABLE `zmyq_subscribe` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='预约表';
